...
g4=as.numeric(as.character(d2[,5]))
g5=as.numeric(as.character(d2[,4]))
...
# setting up the plot function to have 4 plots
par(mfrow=c(2,2))
...
# plot 2
plot(d3,g4,xlab="datetime",ylab="Voltage",type="l",col="black")
...
# adds the 4th plot
plot(d3,g5,xlab="datetime",ylab="Global_reactive_power",type="l",col="black")
